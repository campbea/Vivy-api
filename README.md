...
1. [Add a location](#add-a-location)
1. [Get a list of locations](#get-a-list-of-locations)
1. [Get a location](#get-a-location)
1. [Update a location](#update-a-location)
1. [Delete a location](#delete-a-location)
